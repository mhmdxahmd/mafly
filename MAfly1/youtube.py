...
class Spider(BaseSpider):
    ...
    def categoryContent(self, tid, pg, filter, extend):
        items = [
            ...
            {
                "vod_id": "V1p33hqPrUk",
                "vod_name": "TVBS新闻 24H直播",
                "vod_pic": "https://i.ytimg.com/vi/V1p33hqPrUk/hqdefault.jpg",
                "vod_remarks": "LIVE",
            },
            {
                "vod_id": "m_dhMSvUCIc",
                "vod_name": "东森新闻 24H直播",
                "vod_pic": "https://i.ytimg.com/vi/m_dhMSvUCIc/hqdefault.jpg",
                "vod_remarks": "LIVE",
            },
            {
                "vod_id": "fWlRLYXkVxY",
                "vod_name": "三立新闻 24H直播",
                "vod_pic": "https://i.ytimg.com/vi/fWlRLYXkVxY/hqdefault.jpg",
                "vod_remarks": "LIVE",
            },
            {
                "vod_id": "Ry--eMIjYLQ",
                "vod_name": "台视新闻 24H直播",
                "vod_pic": "https://i.ytimg.com/vi/Ry--eMIjYLQ/hqdefault.jpg",
                "vod_remarks": "LIVE",
            },
        ]
        return {
    ...
    def playerContent(self, flag, id, vipFlags):
        ...
        try:
            ...
            match = re.search(
                r'"hlsManifestUrl"\s*:\s*"(https:[^"]+)"', res.text
            )
            if match:
